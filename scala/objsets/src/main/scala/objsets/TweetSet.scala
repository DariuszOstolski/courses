...
object GoogleVsApple {
  ...
  def filterByGoogle(elem: Tweet) : Boolean = {
    filterHelper(elem, google)
  }
  def filterByApple(elem: Tweet) : Boolean = {
    filterHelper(elem, apple)
  }
  lazy val googleTweets: TweetSet = TweetReader.allTweets.filter(filterByGoogle)
  lazy val appleTweets: TweetSet = TweetReader.allTweets.filter(filterByApple)
